...
def install_thailand_wht_fields():
    ...
    try:
        ...
        # print(
        #     "   - Quotation: subject_to_wht, estimated_wht_amount, net_total_after_wht, net_total_after_wht_in_words"
        # )
        # print(
        #     "   - Sales Order: subject_to_wht, estimated_wht_amount, net_total_after_wht, net_total_after_wht_in_words"
        # )
        print(
            "   - Sales Invoice: subject_to_wht, estimated_wht_amount, wht_certificate_required, net_total_after_wht,"
        )
        print(
            "     net_total_after_wht_in_words, custom_retention, custom_retention_amount,"
        )
        print(
            "     custom_withholding_tax, custom_withholding_tax_amount, custom_payment_amount"
        )
        # print(
        #     "   - Payment Entry: apply_wht, wht_rate, wht_amount, wht_account, net_payment_amount, wht_certificate_no, wht_certificate_date"
        # )
