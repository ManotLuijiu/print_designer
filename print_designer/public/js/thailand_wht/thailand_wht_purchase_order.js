...
frappe.ui.form.on('Purchase Order', {
    ...
    pd_custom_apply_thai_wht_compliance: function(frm) {
        ...
        if (frm.doc.pd_custom_apply_thai_wht_compliance) {
            ...
            console.log('Purchase Order Thai WHT: Auto-enabled pd_custom_subject_to_wht and VAT Undue');
        } else {
    ...
    refresh: function(frm) {
        ...
        if (frm.doc.docstatus === 1 && frm.doc.pd_custom_apply_thai_wht_compliance) {
...
function smart_configure_wht_from_item(frm, item_wht_config, item_code) {
    ...
    if (!frm.doc.pd_custom_apply_thai_wht_compliance) {
        ...
        console.log('✅ Auto-enabled pd_custom_apply_thai_wht_compliance');
    }
    ...
    if (!frm.doc.pd_custom_subject_to_wht) {
        ...
        console.log('✅ Auto-enabled pd_custom_subject_to_wht');
    }
    ...
    if (item_wht_config.pd_custom_wht_income_type &&
        ...
        console.log('✅ Set pd_custom_wht_income_type to:', item_wht_config.pd_custom_wht_income_type);
    }
