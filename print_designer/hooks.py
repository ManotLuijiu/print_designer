...
fixtures = [
    ...
    #                 "Company-pd_custom_wht_description",
    #                 "Company-pd_custom_wht_certificate_required",
    ...
    #                 # Removed redundant Thai Tax Information Fields - using pd_custom_wht_preview_section instead
    ...
    #                 "Sales Invoice-pd_custom_wht_description",
    ...
    #                 "Sales Invoice-pd_custom_wht_note",
    #                 # Sales Invoice - Thai WHT Preview Fields
    #                 "Sales Invoice-pd_custom_wht_preview_section",
    #                 "Sales Invoice-pd_custom_wht_amounts_cb",
    #                 "Sales Invoice-pd_custom_wht_preview_cb",
    #                 # Sales Invoice - Retention System Fields
    #                 "Sales Invoice-pd_custom_subject_to_retention",
    #                 "Sales Invoice-pd_custom_net_after_wht_retention",
    #                 "Sales Invoice-pd_custom_net_after_wht_retention_words",
    #                 "Sales Invoice-pd_custom_retention_note",
    #                 "Sales Invoice-pd_custom_retention_pct",
    #                 "Sales Invoice-pd_custom_retention_amount",
    #                 "Sales Invoice-pd_custom_withholding_tax_pct",
    #                 "Sales Invoice-pd_custom_withholding_tax_amount",
    #                 "Sales Invoice-pd_custom_payment_amount",
    #                 # Quotation - Signature Fields
    #                 "Quotation-pd_custom_prepared_by_signature",
    #                 # Quotation - Watermark Field
    #                 "Quotation-pd_custom_watermark_text",
    #                 # Quotation - VAT Treatment Field
    #                 "Quotation-pd_custom_vat_treatment",
    #                 # Quotation - WHT (Withholding Tax) Fields
    #                 "Quotation-pd_custom_wht_note",
    #                 "Quotation-pd_custom_subject_to_wht",
    #                 "Quotation-pd_custom_wht_description",
    #                 "Quotation-pd_custom_wht_income_type",
    #                 "Quotation-pd_custom_net_total_after_wht_words",
    #                 "Quotation-pd_custom_net_total_after_wht",
    #                 # Quotation - Thai WHT Preview Fields
    #                 "Quotation-pd_custom_wht_preview_section",
    #                 "Quotation-pd_custom_wht_amounts_cb",
    #                 "Quotation-pd_custom_wht_preview_cb",
    #                 # Quotation - Retention System Fields
    #                 "Quotation-pd_custom_subject_to_retention",
    #                 "Quotation-pd_custom_net_after_wht_retention",
    #                 "Quotation-pd_custom_net_after_wht_retention_words",
    #                 "Quotation-pd_custom_retention_pct",
    #                 "Quotation-pd_custom_retention_amount",
    #                 "Quotation-pd_custom_retention_note",
    #                 "Quotation-pd_custom_withholding_tax_pct",
    #                 "Quotation-pd_custom_withholding_tax_amount",
    #                 "Quotation-pd_custom_payment_amount",
    ...
    #                 "Sales Order-pd_custom_watermark_text",
    ...
    #                 "Sales Order-pd_custom_wht_note",
    #                 "Sales Order-pd_custom_wht_description",
    #                 "Sales Order-pd_custom_wht_income_type",
    ...
    #                 "Sales Order-pd_custom_wht_preview_section",
    #                 "Sales Order-pd_custom_wht_amounts_cb",
    #                 "Sales Order-pd_custom_wht_preview_cb",
    #                 # Sales Order - Retention System Fields
    #                 "Sales Order-pd_custom_subject_to_retention",
    #                 "Sales Order-pd_custom_net_after_wht_retention",
    #                 "Sales Order-pd_custom_net_after_wht_retention_words",
    #                 "Sales Order-pd_custom_retention_note",
    #                 "Sales Order-pd_custom_retention_pct",
    #                 "Sales Order-pd_custom_retention_amount",
    #                 "Sales Order-pd_custom_withholding_tax_pct",
    #                 "Sales Order-pd_custom_withholding_tax_amount",
    #                 "Sales Order-pd_custom_payment_amount",
    ...
    #                 "Customer-pd_custom_subject_to_wht",
    #                 "Customer-pd_custom_wht_income_type",
