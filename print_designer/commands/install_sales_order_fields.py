    ...
    return {
        "Sales Order": [
            ...
            },
            {
                ...
                "collapsible": 1,
                "collapsible_depends_on": "eval:doc.pd_custom_subject_to_wht",
                "no_copy": 1,
                "read_only": 1,
                "hidden": 0,
                "length": 0,
            ...
            {
                "fieldname": "pd_custom_deposit_section",
                "fieldtype": "Section Break",
                "label": "Deposit",
            ...
            {
                "fieldname": "pd_custom_has_deposit",
                "fieldtype": "Check",
                "label": "Deposit on 1st Invoice",
                "insert_after": "pd_custom_deposit_section",
            ...
            {
                "fieldname": "pd_custom_deposit_invoice",
                "fieldtype": "Data",
                "label": "Deposit Invoice",
                "insert_after": "pd_custom_has_deposit",
                "no_copy": 1,
                "read_only": 1,
                "hidden": 0,
                "collapsible": 0,
            ...
            {
                "fieldname": "pd_custom_deposit_cb",
                "fieldtype": "Column Break",
                "label": None,
                "insert_after": "pd_custom_deposit_invoice",
                "read_only": 0,
                "hidden": 0,
                "collapsible": 0,
                "length": 0,
            ...
            {
                "fieldname": "pd_custom_percent_deposit",
                "fieldtype": "Percent",
                "label": "Percent Deposit",
                "insert_after": "pd_custom_deposit_cb",
                "read_only": 0,
                "hidden": 0,
                "collapsible": 0,
                "length": 0,
            ...
            {
                "fieldname": "pd_custom_deposit_deduction_method",
                "fieldtype": "Select",
                "label": "Deposit Deduction Method",
                "insert_after": "pd_custom_percent_deposit",
