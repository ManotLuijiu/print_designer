...
Code moved to: thai_business_suite/thai_business_suite/commands/install_thai_billing_fields.py
...
#         "Payment Entry": [
#             {
#                 "fieldname": "pd_custom_thai_billing",
#                 "fieldtype": "Link",
#                 "label": "Thai Billing",
...
#         "Custom Field",
#         {"dt": "Payment Entry", "fieldname": "pd_custom_thai_billing"}
#     )
#
#     if field_exists:
...
#
#     if frappe.db.exists("Custom Field", {"dt": "Payment Entry", "fieldname": "pd_custom_thai_billing"}):
#         frappe.db.delete("Custom Field", {"dt": "Payment Entry", "fieldname": "pd_custom_thai_billing"})
#         frappe.clear_cache()
