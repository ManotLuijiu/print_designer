...
==================================================
REFERENCE FILE - DO NOT RUN
==================================================

This file is kept for reference only.
No hooks are registered for this file.
To use, copy the relevant functions to a new command file.

Purpose: Install WHT Income Type field on Item DocType
Location: Purchase Invoice / Item DocTypes
"""

# For backup / reference only
    ...
    custom_fields = {
        "Item": [
            # WHT Income Type for Purchase Transactions
            {
                ...
                "description": _(
                    "Default WHT income type for this item when used in purchase transactions"
                ),
                "read_only": 0,
                "hidden": 0,
                "collapsible": 0,
...
def uninstall_item_wht_fields():
    ...
    try:
        # Delete custom field
        frappe.db.delete("Custom Field", {"dt": "Item", "fieldname": "pd_custom_wht_income_type"})
