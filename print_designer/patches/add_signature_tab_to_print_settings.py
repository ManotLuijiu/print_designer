...
def execute():
    """Add Signature tab to Print Settings"""
...
"""
    ...
    # Check if client script already exists for Print Settings
    ...
    if existing_scripts:
        ...
        for script in existing_scripts:
            ...
            if "signature" not in doc.script.lower():
                # Append signature functionality to existing script
        ...
        create_new_print_settings_client_script(script_content)


def create_new_print_settings_client_script(script_content):
    """Create new client script for Print Settings"""
    try:
        # Create new client script
