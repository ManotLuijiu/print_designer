...
def execute():
    """Fix signature badges width and count loading issues"""
    
    # Updated CSS and HTML with proper badge styling and JavaScript
    updated_css = """
                ...
                <script>
                // Load signature statistics immediately when the panel loads
                ...
                // Also load stats when form is refreshed
    ...
    try:
        ...
        if custom_field_name:
            ...
            cf.save()
            print(f"✅ Updated Custom Field with improved badges: {custom_field_name}")
        else:
    ...
    frappe.db.commit()
    print("✅ Signature badges width and count loading improved")